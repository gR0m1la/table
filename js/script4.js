strany = ["italy", "france", "switzerland", "hungary", "romania", "japan", "afghanistan", "india", "brazilia", "canada", "argentina", "kolumbia", "england", "mexico"]
...
objectOrder: 0,
	...
	outCountries:function(countries){
		...
		console.log(this.countries1);
		var ptr = this.countries1.map((country, i)=>{
...
function Changes(obj1) {
  this.countries1 = obj1.countries1,
  this.order = [0,0,0,0],
  this.numOrder = 0,
  this.arrayOrder = 0,
  this.twoDArrayOrder = 0, 
  this.objectOrder = 0,
   this.changeCountries =
      function (data){
        if(data==1){
          elem.innerHTML+="<br><h1>Сортировка по возрастанию</h1><br>";
        }
        if(data==0){
          elem.innerHTML+="<br><h1>Сортировка по убыванию</h1><br>";
        }
        for(i in this.countries1)
        for(j in this.countries1[i]){
          if (typeof this.countries1[i][j]=="object"){
            if (typeof this.countries1[i][j][0]=="string") {
              this.countries1[i][j].sort();
              if(data==0){
                this.countries1[i][j].reverse();
              }
            }
          }
        }
...
obj1.outCountries(obj1);
let obj2 = new Changes(obj1);
elem.innerHTML+="<a name=ch1></a>";
obj1.outCountries(obj2);
obj2.changeCountries.call(obj1, 1);
elem.innerHTML+="<a name=ch2></a>";
obj1.outCountries(obj1);
console.log(obj2.countries1);